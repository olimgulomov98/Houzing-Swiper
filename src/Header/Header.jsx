            ...
            <>
                <WrapSkyper>
                    <SwiperReact
                        ...
                        className="mySwiper"
                        >
                        <SwiperReact.Slide style={{backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(${Home3})`}}>
                            <Wrap>
                        ...
                        <SwiperReact.Slide style={{backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(${Home2})`}}>
                        <Wrap>
                                <Wrap.Header>Skyper Pool Partment</Wrap.Header>
                                <Wrap.Paragraph>112 Glenwood Ave Hyde Park, Boston, MA</Wrap.Paragraph>
                                <WrapIcons>
                        ...
                        <SwiperReact.Slide style={{backgroundImage: `linear-gradient(rgba(0, 0, 0, 0.6), rgba(0, 0, 0, 0.6)), url(${Home1})`}}>
                        <Wrap>
                                <Wrap.Header>Skyper Pool Partment</Wrap.Header>
                                <Wrap.Paragraph>112 Glenwood Ave Hyde Park, Boston, MA</Wrap.Paragraph>
                                <WrapIcons>
